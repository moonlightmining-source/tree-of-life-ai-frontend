...
function displayWelcomeMessage() {
    ...
    const welcomeMessage = {
        role: 'assistant',
        content: `Hello ${userName}! 🌿 I'm Tree of Life AI, your integrative health companion. I combine wisdom from 11 medical traditions to provide you with personalized guidance. How can I support your wellness journey today?`,
...
async function createConversation(initialMessage) {
    const response = await fetch(`${API_BASE}/api/chat/conversations`, {
        ...
        body: JSON.stringify({ 
            ...
            user_name: userName // Send user's first name to backend
        })
    });
